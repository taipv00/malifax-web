...
# Script to reset database with default data
...
echo -e "${YELLOW}⚠️  This will delete ALL data in the database and reset with default values.${NC}"
...
echo "🔄 Restarting backend to trigger data initialization..."
